...
from models.models import Lecturer
...
class TestLecturerRepository:
    ...
    def test_create_success(self, lecturer_repository, sample_lecturer_static, mock_session):
    ...
    def test_create_with_session_error(self, lecturer_repository, sample_lecturer_static, mock_session):
    ...
    def test_get_or_create_existing_lecturer(self, lecturer_repository, sample_lecturer_static):
    ...
    def test_get_or_create_new_lecturer(self, lecturer_repository, sample_lecturer_static):
    ...
    def test_get_by_id_success(self, lecturer_repository, mock_session, sample_lecturer_static):
    ...
    def test_get_by_guid_success(self, lecturer_repository, mock_session, sample_lecturer_static):
    ...
    def test_get_with_lessons_success(self, lecturer_repository, mock_session, sample_lecturer_static):
    ...
    def test_update_success(self, lecturer_repository, mock_session, sample_lecturer_static):
    ...
    def test_update_with_none_values(self, lecturer_repository, mock_session, sample_lecturer_static):
    ...
    def test_update_database_error(self, lecturer_repository, mock_session, sample_lecturer_static):
...
class TestLecturerRepositoryIntegration:
    ...
    def test_create_and_retrieve_lecturer(self, lecturer_repository_clean, sample_lecturer):
